...
const TransactionDetails = ({ transaction }: { transaction: Transaction | undefined }) => {
  // pardon me with this curse technique, I just want to code to work
      ...
      <>
        <div className="flex flex-row space-x-2">
          ...
          <div className="max-w- grid max-h-64 grid-cols-[96px_232px] gap-2 overflow-y-auto rounded-lg border bg-white p-4 shadow-md">
            ...
            <p className="max-w-56 break-words text-slate-500">{paymentMethodMap[transaction.paymentMethod]?.label}</p>
