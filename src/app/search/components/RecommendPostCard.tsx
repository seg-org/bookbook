...
function RecommendPostCard({ post }: PostCardProps) {
  return (
    <>
      <div className="flex flex-col overflow-hidden rounded-lg border border-gray-300 bg-sky-500 max-md:w-full md:w-[100%] lg:w-[48%] xl:w-[32%]">
        ...
        <div className="m-2 flex w-full flex-row max-sm:text-sm">
          ...
          <div className="flex w-full flex-col pr-8 lg:h-[290px] xl:h-[320px] 2xl:h-[280px]">
            ...
            <h3 className="self-end dark:text-white">(RECOMMEND)</h3>
